...
namespace NewsApp
{
    public partial class News : Form
    {
        ...
        private void News_Load(object sender, EventArgs e)
        {
            ...
            if (LastNewsDate != news.Articles[0].PublishedAt)
            {
                notifyIcon1.Visible = true;
                notifyIcon1.BalloonTipTitle = Title;
                notifyIcon1.BalloonTipText = news.Articles[0].Description ?? "(No description)";
            ...
            LastNewsDate = news.Articles[0].PublishedAt;
